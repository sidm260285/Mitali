            ...
            <tbody>
                @forelse($transactions as $transaction)
                    <tr class="transaction-row" role="button" style="cursor: pointer;"
                        data-url="{{ route('admin.bank-flow.transactions.show', $transaction) }}">
            ...
            fetch(url, { headers: { 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest' } })
                ...
                .then(data => {
                    ...
                    body.innerHTML =
                        ...
                        '<dt class="col-sm-4">Ref Transaction ID</dt><dd class="col-sm-8">' + data.transaction.transaction_id + '</dd>' +
                        ...
                        '<dt class="col-sm-4">Entry By</dt><dd class="col-sm-8">' + data.transaction.entry_by + '</dd>' +
