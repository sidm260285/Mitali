<div class="card shadow-sm border-0 mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('admin.bank-flow.transactions.index') }}" class="row g-3 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <label for="transaction_id" class="form-label">Ref Transaction ID</label>
                <input type="text" name="transaction_id" id="transaction_id" class="form-control"
                       value="{{ request('transaction_id') }}" placeholder="Search ref ID...">
            </div>
            <div class="col-md-12">
                <button type="submit" class="btn btn-primary me-2">Apply Filters</button>
                <a href="{{ route('admin.bank-flow.transactions.index') }}" class="btn btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
