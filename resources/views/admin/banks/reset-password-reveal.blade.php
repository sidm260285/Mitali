            ...
            <div class="card shadow-sm border-0 border-warning">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted">
                        ...
                        <strong>{{ $bank->name }}</strong> ({{ $bank->username }}).
                    ...
                    <p class="small text-muted mb-4">
                        The bank user must use this password to log in and will be required to set a new password.
                    </p>
                    <a href="{{ route('admin.banks.index') }}" class="btn btn-primary">Back to Banks</a>
                </div>
            </div>
        </div>
    </div>
